...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Valenzuela Franco Iram Israel", NULL, NULL);
	...
	float vertices[] = {
		...
		// 1T
		-0.5f, 0.1f, 0.0f,    1.0f,0.3f,0.5f,
		-0.3f, 0.1f, 0.0f,    1.0f,0.3f,0.5f,
		-0.6f, 0.2f, 0.0f,    1.0f,0.3f,0.5f,
		// 2T
		-0.3f, 0.1f, 0.0f,    1.0f,0.3f,0.5f,
		-0.6f, 0.2f, 0.0f,    1.0f,0.3f,0.5f,
		-0.6f, 0.4f, 0.0f,    1.0f,0.3f,0.5f,
		// 3T
		-0.3f, 0.1f, 0.0f,    1.0f,0.3f,0.5f,
		-0.6f, 0.4f, 0.0f,    1.0f,0.3f,0.5f,
		-0.4f, 0.6f, 0.0f,    1.0f,0.3f,0.5f,
		//4t
		-0.3f, 0.1f, 0.0f,    1.0f,0.3f,0.5f,
		-0.4f, 0.6f, 0.0f,    1.0f,0.3f,0.5f,
		-0.1f, 0.5f, 0.0f,    1.0f,0.3f,0.5f,
		//5t
		-0.3f, 0.1f, 0.0f,   1.0f,0.3f,0.5f,
		-0.1f, 0.5f, 0.0f,   1.0f,0.3f,0.5f,
		-0.1f, 0.3f, 0.0f,   1.0f,0.3f,0.5f,
		//6t
		-0.6f, 0.4f, 0.0f,   1.0f,0.3f,0.5f,
		-0.55f, 0.55f, 0.0f, 1.0f,0.3f,0.5f,
		-0.4f, 0.6f, 0.0f,   1.0f,0.3f,0.5f,
